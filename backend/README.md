...
## Project Structure
    ...
    ├── testapiautostoryboa_85198  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_85198`
...
2. Clone this repo and `cd testapiautostoryboa_85198`
